...
class VertexAIService:
    ...
    async def list_agents(self, project_id: str, region: str) -> List[Dict[str, Any]]:
        ...
        url = f"https://{region}-aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/agents"
    ...
    async def get_agent(self, project_id: str, region: str, agent_id: str) -> Dict[str, Any]:
        ...
        url = f"https://{region}-aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/agents/{agent_id}"
    ...
    async def deploy_agent(self, project_id: str, region: str, agent_id: str) -> Dict[str, Any]:
        """Deploys an agent."""
        url = f"https://{region}-aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/agents/{agent_id}:deploy"
    ...
    async def query_agent(self, project_id: str, region: str, agent_id: str, query: str, max_response_items: int = 10) -> Dict[str, Any]:
        """Queries an agent."""
        url = f"https://{region}-aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/agents/{agent_id}:query"
